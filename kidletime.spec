...
Source0  : https://download.kde.org/stable/frameworks/5.105/kidletime-5.105.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.105/kidletime-5.105.0.tar.xz.sig
...
%prep
%setup -q -n kidletime-5.105.0
cd %{_builddir}/kidletime-5.105.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681145284
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IdleTime.so.5.105.0
